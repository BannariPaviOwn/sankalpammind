    ...
    <div className="about-page">
      ...
      <section className="about-content">
        <div className="about-card story-card">
          ...
          <p>
            {t(
              '"SANKALPAM" means a conscious intention — a deep commitment to act with purpose. The foundation was born from a simple yet urgent realization: Mental health support often reaches people too late — and rarely reaches rural and underserved communities at all. While therapy rooms exist in cities, silent struggles continue in villages, schools, homes, and workplaces where awareness, access, and affordability remain barriers. SANKALPAM was created to bridge that gap: From stigma to strength • From crisis response to prevention • From urban privilege to community access. We believe that when emotional wellbeing begins at the roots, lasting social change becomes possible.',
              'संकल्पम का अर्थ है एक सचेत इरादा — उद्देश्य के साथ कार्य करने की गहरी प्रतिबद्धता। फाउंडेशन एक सरल लेकिन जरूरी अनुभव से पैदा हुआ: मानसिक स्वास्थ्य सहायता अक्सर लोगों तक बहुत देर से पहुंचती है — और ग्रामीण और वंचित समुदायों तक शायद ही कभी पहुंचती है।',
              '"సంకల్పం" అంటే ఒక స్పృహతో కూడిన ఉద్దేశ్యం — ఉద్దేశ్యంతో పనిచేయడానికి లోతైన నిబద్ధత. ఫౌండేషన్ ఒక సాధారణమైన కానీ అత్యవసరమైన అవగాహన నుండి జన్మించింది: మానసిక ఆరోగ్య మద్దతు తరచుగా ప్రజలకు చాలా ఆలస్యంగా చేరుతుంది — మరియు గ్రామీణ మరియు అల్పసేవా సమాజాలకు అరుదుగా చేరుతుంది. మేము ఆ ఖాళీను పూరిస్తాము.'
            )}
          </p>
        </div>
